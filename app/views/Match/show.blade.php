...
<table id="match_preview">
	...
	<tr>
		<td class="center country_flag"><img src="/l4/images/countries/{{$player1->country}}.png" alt="Player 1 flag" /></td>
		<td class="title center" colspan="2">Country</td>
		<td class="center country_flag"><img src="/l4/images/countries/{{$player2->country}}.png" alt="Player 2 flag" /></td>
	</tr>
	<tr>
