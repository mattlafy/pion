...
{{Form::label('sc2_alias', 'Character Code:')}} {{Form::text('sc2_alias')}}.{{Form::text('char_code')}}<br><span class='important'>Find your Character code by hovering your mouse over your character portrait on battle.net, It will look like this Name.999</span><br>
